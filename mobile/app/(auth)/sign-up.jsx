...
const SignUpScreen = () => {
  ...
  const handleSignUp = async () => {
    if (!name || !email || !password || !confirmPassword) {
      Alert.alert("Error", "Tolong isi semua kolom");
      return;
    }
    ...
    try {
      ...
      Alert.alert("Error", err.errors?.[0]?.message || "Gagal membuat akun");
      ...
      <View style={styles.headerBg}>
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerSubtitle}>
            Daftar sekarang dan mulai periksa kualitas daging dengan mudah.
          </Text>
        </View>
      </View>
        ...
        >
          <View style={styles.formCard}>
            ...
            <View style={styles.tabSwitcher}>
              ...
              >
                <Text style={styles.tabInactiveText}>Masuk</Text>
              </TouchableOpacity>
              <View style={styles.tabActive}>
                <Text style={styles.tabActiveText}>Daftar</Text>
              </View>
            </View>
